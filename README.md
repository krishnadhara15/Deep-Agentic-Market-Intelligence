...
5. Runs a **thinker/verifier** with **sequential reasoning** to detect gaps and spawn follow-up research (bounded loop)
...
See [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) for how the design maps to the project's three Specific Aims.
...
| Reasoning | Sequential-thinking (MCP-pattern) + verifier gap analysis | [src/sequential_thinking.py](src/sequential_thinking.py), [src/nodes.py](src/nodes.py) |
...
│   ├── sequential_thinking.py # Sequential reasoning (MCP pattern)
...
│   └── main.py                # CLI
├── docs/                      # ARCHITECTURE.md, presentation_outline.md
├── outputs/                   # Generated artifacts
├── scripts/smoke_test.py      # Graph-compile smoke test
└── requirements.txt
```

## Technologies

Python · LangGraph · LangChain · Google Gemini (`gemini-2.5-flash`) · Tavily · networkx · pyvis · Streamlit.
